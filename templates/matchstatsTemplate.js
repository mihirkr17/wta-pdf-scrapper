...
const matchstatsTemplate = [
   ...
   },
   {
      ...
      tpMetaTitle: "Predicción de #player1Surname vs #player2Surname H2H, ¿Quién ganará en el WTA #eventName #eventYear?",
   ...
   },
   {
      ...
      tpMetaTitle: "Previsão de #player1Surname vs #player2Surname H2H, Quem vencerá no WTA #eventName #eventYear?",
   ...
   },
   {
      ...
      tpMetaTitle: "Prédiction de #player1Surname vs #player2Surname H2H, Qui va gagner au WTA #eventName #eventYear ?",
   ...
   },
   {
      ...
      tpMetaTitle: "Prognose für #player1Surname vs #player2Surname H2H, Wer wird beim WTA #eventName #eventYear gewinnen?",
   ...
   },
   {
      ...
      tpMetaTitle: "Pronostico di #player1Surname vs #player2Surname H2H, Chi vincerà al WTA #eventName #eventYear?",
   ...
   },
   {
      ...
      tpMetaTitle: "Przewidywania dla #player1Surname vs #player2Surname H2H, Kto wygra na WTA #eventName #eventYear?",
   ...
   },
   {
      ...
      tpMetaTitle: "Voorspelling van #player1Surname vs #player2Surname H2H, Wie zal winnen op het WTA #eventName #eventYear?",
